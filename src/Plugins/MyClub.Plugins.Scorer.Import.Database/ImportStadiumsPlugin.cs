...
{
    public class ImportStadiumsPlugin : ImportItemsPlugin<StadiumImportDto>, IImportStadiumsPlugin
    {
        public ImportStadiumsPlugin() : base(DatabaseService.CreateContext) { }
