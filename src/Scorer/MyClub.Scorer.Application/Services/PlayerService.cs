...
{
    public class PlayerService(IPlayerRepository repository, ITeamRepository teamRepository) : CrudService<Player, PlayerDto, IPlayerRepository>(repository)
    {
        private readonly ITeamRepository _teamRepository = teamRepository;

        protected override Player CreateEntity(PlayerDto dto)
        {
        ...
        protected override void UpdateEntity(Player entity, PlayerDto dto)
        {
        ...
        public PlayerDto New(Guid teamId)
        {
