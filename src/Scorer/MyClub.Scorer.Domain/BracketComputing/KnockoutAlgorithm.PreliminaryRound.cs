...
{
    public class PreliminaryRoundAlgorithm : IRoundsAlgorithm
    {
        public static PreliminaryRoundAlgorithm Default => new();
        ...
        public BracketRound Compute(IEnumerable<IVirtualTeam> teams)
        {
            ...
            while (remainingTeams.Count >= 2 && fixtures.Count < numberOfFixturesForFirstRound)
            {
