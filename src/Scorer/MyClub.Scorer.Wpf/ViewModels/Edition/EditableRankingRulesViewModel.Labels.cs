...
namespace MyClub.Scorer.Wpf.ViewModels.Edition
{
    ...
    internal class EditableRankingLabelsViewModel : ListViewModel<EditableRankLabelViewModel>
    {
        public EditableRankingLabelsViewModel() : base()
        {
        ...
        public void Update(int ranksCount) => Ranks.Reload(ranksCount);

        public void Load(Dictionary<AcceptableValueRange<int>, RankLabel> rankingLabels)
    ...
    internal class RanksListViewModel : SelectionListViewModel<EditableRankViewModel>
    {
        ...
        public override void ResetIsModified() => Collection.ForEach(x => x.ResetIsModified());
    }
