...
{
    internal class ProjectCreationTeamsViewModel : TeamsViewModelBase<EditableTeamViewModel>
    {
        ...
        public ProjectCreationTeamsViewModel(PluginsService pluginsService, ISourceProvider<EditableStadiumViewModel> stadiumsProvider)
