...
{
    internal class ProjectEditionStadiumsViewModel : StadiumsViewModelBase<EditableStadiumViewModel>
    {
        private readonly PluginsService _pluginsService;
        private readonly AddressService _addressService;

        public ProjectEditionStadiumsViewModel(PluginsService pluginsService, AddressService addressService) : base(pluginsService.HasPlugin<IImportStadiumsSourcePlugin>())
        {
