...
{
    internal class MatchSchedulingAssistantViewModel : EditionViewModel
    {
        private TimeSpan? _time;
        private DateTime? _date;

        public MatchSchedulingAssistantViewModel(IEnumerable<SchedulingSerie> series, DateTime? date)
        {
