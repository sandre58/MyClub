...
{
    internal class PositionsSelector : ListBox, IDropTarget, IDragSource
    {
        static PositionsSelector()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PositionsSelector), new FrameworkPropertyMetadata(typeof(PositionsSelector)));
            KeyboardNavigation.TabNavigationProperty.OverrideMetadata(typeof(PositionsSelector), new FrameworkPropertyMetadata(KeyboardNavigationMode.Once));
            KeyboardNavigation.DirectionalNavigationProperty.OverrideMetadata(typeof(PositionsSelector), new FrameworkPropertyMetadata(KeyboardNavigationMode.Contained));
        }
        public PositionsSelector()
        {
        ...
        public static readonly DependencyProperty CanMoveProperty = DependencyProperty.Register(nameof(CanMove), typeof(bool), typeof(PositionsSelector), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty CanSelectProperty = DependencyProperty.Register(nameof(CanSelect), typeof(bool), typeof(PositionsSelector), new PropertyMetadata(true));
