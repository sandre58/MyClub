...
{
    internal class ImportSourceChangedEventArgs : EventArgs
    {
    ...
    internal class ImportSelectSourceViewModel<T> : ObservableObject, IItemsProvider<T> where T : ImportableViewModel
    {
