...
namespace MyClub.Teamup.Wpf.ViewModels.Import
{
    ...
    internal abstract class ImportViewModel<T> : ItemsSelectionViewModel<T>
        where T : notnull, ImportableViewModel
    {
        ...
        protected ImportViewModel(ProjectInfoProvider projectInfoProvider,
                                  ImportSelectSourceViewModel<T> selectSourceViewModel,
            ...
            : base(selectSourceViewModel, parametersProvider: parametersProvider, title: title ?? UiResources.Import)
        {
            ...
            projectInfoProvider.WhenProjectChanged(_ => Reset());
